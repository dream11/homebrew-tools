...
class Livelogs < Formula
  ...
  homepage "https://github.com/ds-horizon/livelogs"
  version "0.2.5"

  # For MacOs Intel based systems
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/ds-horizon/livelogs/releases/download/0.2.5/livelogs_darwin_amd64.tar.gz"
    sha256 "ce6bcdf6fefdcc113b16f1740d79438027fe6fd1e8ccf06d10e57fa8d8a61197"
  end

  # For MacOs M1 based systems
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/ds-horizon/livelogs/releases/download/0.2.5/livelogs_darwin_arm64.tar.gz"
    sha256 "87fc79e174f1feb129cd508b0c17024ba56bd38232d5d39ec8b832dd97b03fd9"
  end

  # For Linux X64 based systems
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/ds-horizon/livelogs/releases/download/0.2.5/livelogs_linux_amd64.tar.gz"
