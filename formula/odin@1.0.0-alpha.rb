...
class OdinAT100Alpha < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://github.com/dream11/odin/releases/download/1.0.0-alpha/odin_darwin_amd64.tar.gz"
    sha256 "ba833d556af4a47923fcb8780ca31492369808eea2165c733f5b5fd25c3885a7"
  end

  # For MacOs M1 based systems
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/dream11/odin/releases/download/1.0.0-alpha/odin_darwin_arm64.tar.gz"
    sha256 "4c5d45c7ad41cd217aa9f1bc906b921161a2554cb3e5084f3188ffd347ccc7b9"
  end

  # For Linux X64 based systems
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/dream11/odin/releases/download/1.0.0-alpha/odin_linux_amd64.tar.gz"
